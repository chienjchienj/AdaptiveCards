...
namespace AdaptiveNamespace
{
                                    ...
                                    _COM_Outptr_ IUIElement** imageControl)
    {
        ...
        if (imageStyle == ImageStyle_Person)
        {
            ...
            {
                RETURN_IF_FAILED(ellipseAsShape->put_Stretch(stretch));
                RETURN_IF_FAILED(backgroundEllipseAsShape->put_Stretch(stretch));
            }
        ...
        else
        {
            ...
            case ABI::AdaptiveNamespace::ImageSize::Small:
            {
                ...
                RETURN_IF_FAILED(frameworkElement->put_Width(imageSize));
                RETURN_IF_FAILED(frameworkElement->put_Height(imageSize));
                break;
            }
